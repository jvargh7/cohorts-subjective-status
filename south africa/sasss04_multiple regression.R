...
result_path_mr %>% 
  write.csv(.,paste0(path_dissertation,"/aim 3/working/cohorts/south africa/multiple regression coefficients.csv"),row.names = FALSE)

result_path_all_model %>% 
  write.csv(.,paste0(path_dissertation,"/aim 3/working/cohorts/south africa/all model coefs.csv"),row.names = FALSE)
